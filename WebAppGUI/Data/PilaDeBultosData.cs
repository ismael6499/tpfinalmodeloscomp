...
namespace Data
{
    public class PilaDeBultosData
    {
        private static readonly object _lock = new object();
        private static PilaDeBultosData _instance;

        private readonly SqlConnection _connection;
        private SqlTransaction transaction;

        private PilaDeBultosData()
        {
            var connectionString = Program.configuration["ConnectionStrings:ConnectionPilaBultos"];
        ...
        public static PilaDeBultosData GetInstance()
        {
            lock (_lock)
            {
                if (_instance == null) _instance = new PilaDeBultosData();
                return _instance;
            }
        }
    }
