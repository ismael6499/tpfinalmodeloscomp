...
namespace Data
{
    public class CintaData
    {
        private static readonly object _lock = new object();
        private static CintaData _instance;
        ...
        private CintaData()
        {
            var connectionString = Program.configuration["ConnectionStrings:ConnectionCinta"];
        ...
        public static CintaData GetInstance()
        {
            lock (_lock)
            {
                if (_instance == null) _instance = new CintaData();
                return _instance;
            }
        }
    }
