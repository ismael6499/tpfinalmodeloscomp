...
{
    public class BrazoData
    {
        private static readonly object _lock = new object();
        private static BrazoData _instance;
        ...
        private BrazoData()
        {
            var connectionString = Program.configuration["ConnectionStrings:ConnectionBrazo"];
        ...
        public static BrazoData GetInstance()
        {
            lock (_lock)
            {
                if (_instance == null) _instance = new BrazoData();
                return _instance;
            }
        }
    }
