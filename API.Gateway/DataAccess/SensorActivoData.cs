...
{
    public class SensorActivoData

    {
        private static readonly object _lock = new object();
        private static SensorActivoData _instance;

        private readonly SqlConnection _connection;
        private SqlTransaction transaction;

        private SensorActivoData()
        {
            var connectionString = Program.configuration["ConnectionStrings:ConnectionSensorActivo"];
        ...
        public static SensorActivoData GetInstance()
        {
            lock (_lock)
            {
                if (_instance == null) _instance = new SensorActivoData();
                return _instance;
            }
        }
    }
